...
class MainWindow(QMainWindow):
    ...
    def formatLabelOutput(self, names,addrs,data,colors=[""]):
        ...
        for i in range(len(names)):
            spacestring1 = " "
            spacestring2 = " "
            outst = outst+f"<p><font color={colors[i]}>"+"<span style= \"border:2px solid black\">"+names[i] +"<span>"+spacestring1 + "<span style= \"border:2px solid black\">"+addrs[i] + "</span>"+spacestring2 + "<span style= \"border:2px solid black\">"+data[i] + "</span></font></p>"
